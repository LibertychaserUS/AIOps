...
- **PR 名 / 解说规格：** 分工只写 **PR 标题前缀** `[<role>][<product>]`，不是分支 / workflow / skill 名。正文六节。开发写，管理拒收无规格。[`docs/pr-brief.md`](docs/pr-brief.md)。模板：[`.github/PULL_REQUEST_TEMPLATE.md`](.github/PULL_REQUEST_TEMPLATE.md)。
