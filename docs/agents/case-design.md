...
name: case-design
description: >-
  How Overlay designs cases and what “full cover” means. Local triad,
  declared invariants, interaction only when leaves are coupled. Use when
  writing cases.md, invariants.yaml, or asking how to catch global corner
  cases. Not line coverage. Not a second PRD.
---

# 用例设计与标准化覆盖

Agent 先读 [`overlay-contract.md`](overlay-contract.md)，再读本文 + [`../test-spec.md`](../test-spec.md)。对照：[`ieee-test-system.md`](ieee-test-system.md)。
