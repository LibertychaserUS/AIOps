...
- Skills are Agent Skills `SKILL.md` (frontmatter `name` + `description`; `name` matches the directory). Discovery: `.agents/skills/` (Codex), `.cursor/skills/` (Cursor), `.claude/skills/` (Claude Code) — symlinks to `skills/`. Import commands: README § Native skills.
